...
// const baseUrl = "https://fullstack-open-exercises-part3-w00b.onrender.com/api/persons"; // New base url for deployment in Render for exercise 3.11 (testing locally)
const getAllPersons = () => {
...
const getPersonById = (id) => {
  return axios
    ...
    .catch((error) => console.log(error.data.response.data.error));
};
